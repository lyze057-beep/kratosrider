...
type Data struct {
	...
	Sms       *Data_Sms       `protobuf:"bytes,4,opt,name=sms,proto3" json:"sms,omitempty"`
	AiService *Data_AIService `protobuf:"bytes,5,opt,name=ai_service,json=aiService,proto3" json:"ai_service,omitempty"`
}
...
func (x *Data) GetAiService() *Data_AIService {
	if x != nil {
		return x.AiService
	}
	return nil
...
func (x *Data_Rabbitmq) GetVirtualHost() string {
	if x != nil {
...
func (x *Data_Rabbitmq) GetConnectionTimeout() *durationpb.Duration {
	if x != nil {
...
func (x *Data_Sms) GetApiId() string {
	if x != nil {
		return x.ApiId
	}
	return ""
...
func (x *Data_Sms) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
type Data_AIService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OcrAccessKey      string `protobuf:"bytes,1,opt,name=ocr_access_key,json=ocrAccessKey,proto3" json:"ocr_access_key,omitempty"`
	OcrSecretKey      string `protobuf:"bytes,2,opt,name=ocr_secret_key,json=ocrSecretKey,proto3" json:"ocr_secret_key,omitempty"`
	AsrAppId          string `protobuf:"bytes,3,opt,name=asr_app_id,json=asrAppId,proto3" json:"asr_app_id,omitempty"`
	AsrToken          string `protobuf:"bytes,4,opt,name=asr_token,json=asrToken,proto3" json:"asr_token,omitempty"`
	LlmApiKey         string `protobuf:"bytes,5,opt,name=llm_api_key,json=llmApiKey,proto3" json:"llm_api_key,omitempty"`
	LlmBaseUrl        string `protobuf:"bytes,6,opt,name=llm_base_url,json=llmBaseUrl,proto3" json:"llm_base_url,omitempty"`
	LlmModel          string `protobuf:"bytes,7,opt,name=llm_model,json=llmModel,proto3" json:"llm_model,omitempty"`
	EmbeddingApiKey   string `protobuf:"bytes,8,opt,name=embedding_api_key,json=embeddingApiKey,proto3" json:"embedding_api_key,omitempty"`
	EmbeddingBaseUrl  string `protobuf:"bytes,9,opt,name=embedding_base_url,json=embeddingBaseUrl,proto3" json:"embedding_base_url,omitempty"`
...
func (x *Data_AIService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_AIService) ProtoMessage() {}

func (x *Data_AIService) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_AIService.ProtoReflect.Descriptor instead.
func (*Data_AIService) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{2, 4}
}

func (x *Data_AIService) GetOcrAccessKey() string {
	if x != nil {
		return x.OcrAccessKey
	}
	return ""
}

func (x *Data_AIService) GetOcrSecretKey() string {
	if x != nil {
		return x.OcrSecretKey
	}
	return ""
}

func (x *Data_AIService) GetAsrAppId() string {
	if x != nil {
		return x.AsrAppId
	}
	return ""
...
func (x *Data_AIService) GetAsrToken() string {
	if x != nil {
		return x.AsrToken
	}
	return ""
...
func (x *Data_AIService) GetLlmApiKey() string {
	if x != nil {
		return x.LlmApiKey
	}
	return ""
...
func (x *Data_AIService) GetLlmBaseUrl() string {
	if x != nil {
		return x.LlmBaseUrl
	}
	return ""
...
func (x *Data_AIService) GetLlmModel() string {
	if x != nil {
		return x.LlmModel
	}
	return ""
...
func (x *Data_AIService) GetEmbeddingApiKey() string {
	if x != nil {
...
func (x *Data_AIService) GetEmbeddingBaseUrl() string {
	if x != nil {
...
func (x *Data_AIService) GetEmbeddingModel() string {
	if x != nil {
...
var file_conf_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x22, 0xd2, 0x07, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0xc3, 0x01, 0x0a, 0x08, 0x52, 0x61, 0x62, 0x62, 0x69,
	0x74, 0x6d, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x73, 0x74, 0x12, 0x48, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
...
var file_conf_proto_goTypes = []any{
	...
	(*Data_AIService)(nil),      // 9: kratos.api.Data.AIService
...
var file_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Data.ai_service:type_name -> kratos.api.Data.AIService
	...
	10, // 13: kratos.api.Data.Rabbitmq.connection_timeout:type_name -> google.protobuf.Duration
