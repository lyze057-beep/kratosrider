...
func wireApp(serverConfig *conf.Server, dataConfig *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(serverConfig, greeterService, authService, orderService, messageService, incomeService, logger)
	httpServer := server.NewHTTPServer(serverConfig, greeterService, authService, orderService, messageService, incomeService, logger)
